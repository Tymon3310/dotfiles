...
Singleton {
    ...
    // 600 samples at 0.5 s: five minutes. One rate for every series keeps the
    // time axis uniform.
    readonly property int pollInterval: 500
    readonly property int historyLength: 600
    ...
    readonly property Process sampler: Process {
        ...
        command: [Quickshell.shellPath("parts/scripts/stats.py"), "watch",
